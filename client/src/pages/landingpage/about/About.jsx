  ...
  return (
    <div>
      ...
      <div className=" flex flex-col gap-5 mb-4">
        <div>
          <p>About Fash-Craft</p>
        </div>
        <p className="font-palanquin mb-4">
          ...
          enterprise management. Fash-Craft ERP is more than just software; It
          is a dedicated solution designed to streamline and optimize every
          aspect of your fashion enterprise.
        </p>
      </div>
      <div>
        ...
        <div className="w-[700px] m-auto flex flex-col gap-5 mb-4">
          <p> Crafting Enterprise Efficiency </p>
          <div>
            <p>
        ...
        <div className="w-[700px] m-auto flex flex-col gap-5 mb-4">
          <p> Why Choose Fash-Craft Fashion ERP </p>
        </div>
        <div className="w-[700px] m-auto flex flex-col gap-5 mb-4">
          <p> End-to-End Solution: </p>
          <div>
            <p>
              Fash-Craft offers a comprehensive suite of ERP modules tailored to
              the fashion industry. From design and production management to
              inventory control and sales analysis, our ERP system covers it
              all.
            </p>
          </div>
        </div>
        ...
        <div className="w-[700px] m-auto flex flex-col gap-5 mb-4">
          ...
          <div>
            ...
            includes tools for design and trend management, production planning,
          ...
          <div>
            <p>
            We prioritize ease of use. Fash-Craft Fashion ERP is designed with
            an intuitive interface, making it accessible to users across your
            organization.
            </p>
          </div>
          </div>
